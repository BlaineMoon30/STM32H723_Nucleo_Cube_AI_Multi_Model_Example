...
#define AI_MODEL_1_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF
#define AI_MODEL_2_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF

#define AI_MNETWORK_DATA_ACTIVATIONS_INT_SIZE AI_MODEL_1_DATA_ACTIVATIONS_SIZE
