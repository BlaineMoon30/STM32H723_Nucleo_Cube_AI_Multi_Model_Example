...
/******************************************************************************/
#define AI_MODEL_1_MODEL_NAME          "model_1"
#define AI_MODEL_1_ORIGIN_MODEL_NAME   "housing"

/******************************************************************************/
#define AI_MODEL_1_ACTIVATIONS_ALIGNMENT   (4)
//#define AI_MODEL_1_INPUTS_IN_ACTIVATIONS   (4)
//#define AI_MODEL_1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_1_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_1_IN \
  ai_model_1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_1_IN_SIZE { \
  AI_MODEL_1_IN_1_SIZE, \
}
#define AI_MODEL_1_IN_SIZE_BYTES { \
  AI_MODEL_1_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_1_IN_1_CHANNEL     (13)
#define AI_MODEL_1_IN_1_SIZE        (13)
#define AI_MODEL_1_IN_1_SIZE_BYTES  (52)

/******************************************************************************/
#define AI_MODEL_1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_1_OUT \
  ai_model_1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_1_OUT_SIZE { \
  AI_MODEL_1_OUT_1_SIZE, \
}
#define AI_MODEL_1_OUT_SIZE_BYTES { \
  AI_MODEL_1_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_1_OUT_1_CHANNEL     (1)
#define AI_MODEL_1_OUT_1_SIZE        (1)
#define AI_MODEL_1_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODEL_1_N_NODES (5)
 ...
 * @ref ai_model_1_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_1_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_1_*
 * defines into file @ref model_1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
