...
#define AI_NETWORK_MODEL_SIGNATURE     "414cfc7a4fc582ea0e33072b635bdac7"
...
#define AI_TOOLS_DATE_TIME   "Mon Jun 20 16:57:17 2022"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    conv2d_conv2d_output_array.data = AI_PTR(activations_map[0] + 864);
    conv2d_conv2d_output_array.data_start = AI_PTR(activations_map[0] + 864);
    dense_dense_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_dense_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_1_dense_output_array.data = AI_PTR(activations_map[0] + 48);
    dense_1_dense_output_array.data_start = AI_PTR(activations_map[0] + 48);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    conv2d_conv2d_bias_array.data = AI_PTR(weights_map[0] + 1536);
    conv2d_conv2d_bias_array.data_start = AI_PTR(weights_map[0] + 1536);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(weights_map[0] + 1632);
    dense_dense_weights_array.data_start = AI_PTR(weights_map[0] + 1632);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(weights_map[0] + 12000);
    dense_dense_bias_array.data_start = AI_PTR(weights_map[0] + 12000);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(weights_map[0] + 12048);
    dense_1_dense_weights_array.data_start = AI_PTR(weights_map[0] + 12048);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(weights_map[0] + 12240);
    dense_1_dense_bias_array.data_start = AI_PTR(weights_map[0] + 12240);
    return true;
  }
