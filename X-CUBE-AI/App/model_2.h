...
/******************************************************************************/
#define AI_MODEL_2_MODEL_NAME          "model_2"
#define AI_MODEL_2_ORIGIN_MODEL_NAME   "housing"

/******************************************************************************/
#define AI_MODEL_2_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_2_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_2_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_2_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_2_IN \
  ai_model_2_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_2_IN_SIZE { \
  AI_MODEL_2_IN_1_SIZE, \
}
#define AI_MODEL_2_IN_SIZE_BYTES { \
  AI_MODEL_2_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_2_IN_1_CHANNEL     (13)
#define AI_MODEL_2_IN_1_SIZE        (13)
#define AI_MODEL_2_IN_1_SIZE_BYTES  (52)

/******************************************************************************/
#define AI_MODEL_2_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_2_OUT \
  ai_model_2_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_2_OUT_SIZE { \
  AI_MODEL_2_OUT_1_SIZE, \
}
#define AI_MODEL_2_OUT_SIZE_BYTES { \
  AI_MODEL_2_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_2_OUT_1_CHANNEL     (1)
#define AI_MODEL_2_OUT_1_SIZE        (1)
#define AI_MODEL_2_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODEL_2_N_NODES (5)
 ...
 * @ref ai_model_2_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_2_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_2_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_2_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_2_*
 * defines into file @ref model_2.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
